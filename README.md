...
To use this specific version of the SDK, append `#4.0.0-beta.2` to the URL, but note that this will stop Unity from suggesting version updates automatically.
