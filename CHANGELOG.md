...
- Bump .NET SDK from v4.2.1 to v4.3.0 ([#1614](https://github.com/getsentry/sentry-unity/pull/1614))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#430)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/4.2.1...4.3.0)
