...
- The SDK now handles WebGL limitations more gracefully by logging and setting options explicitly instead of relying on fallbacks ([#2322](https://github.com/getsentry/sentry-unity/pull/2322))
