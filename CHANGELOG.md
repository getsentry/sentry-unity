...
- Bump Native SDK from v0.7.0 to v0.7.1 ([#1596](https://github.com/getsentry/sentry-unity/pull/1596))
...
- Bump Cocoa SDK from v8.21.0 to v8.22.4 ([#1597](https://github.com/getsentry/sentry-unity/pull/1597))
