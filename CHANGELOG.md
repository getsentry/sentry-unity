...
- Bump .NET SDK from v4.10.2 to v4.11.0 ([#1808](https://github.com/getsentry/sentry-unity/pull/1808))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#4110)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/4.10.2...4.11.0)
