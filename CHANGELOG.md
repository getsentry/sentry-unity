...
- Added minimum breadcrumb level to the options ([#1030](https://github.com/getsentry/sentry-unity/pull/1030))
...
- Bump Native SDK from v0.5.0 to v0.5.1 ([#1022](https://github.com/getsentry/sentry-unity/pull/1022))
