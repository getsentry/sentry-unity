...
{
    public class SentryInstallation : AssetPostprocessor
    {
        ...
        private static void InitializeOnLoad()
        {
            ...
            foreach (var package in packages)
            {
                ...
                {
                    SentryInstallationWindow window  = (SentryInstallationWindow)EditorWindow.GetWindow(typeof(SentryInstallationWindow), true, "Sentry Sentry.png");
                }
            }
        }
    }

    public class SentryInstallationWindow : EditorWindow
    {
        private void OnGUI()
        {
            GUILayout.Label("Welcome to Sentry.\nDocs\nDSN?");
        }
    }
}
