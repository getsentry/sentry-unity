...
/// <summary>
/// Parses Unity-formatted stacktraces into Sentry stack frames
/// </summary>
internal static class UnityStackTraceParser
{
    ...
    /// <summary>
    /// Parses a Unity stacktrace string into structured SentryStackFrames
    /// </summary>
    ...
    public static List<SentryStackFrame> Parse(string stackTrace, SentryOptions? options)
    {
