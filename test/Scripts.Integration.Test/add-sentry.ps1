...
Copy-Item -Recurse "$IntegrationScriptsPath/Editor/OptionsConfig.cs" -Destination "$(GetNewProjectAssetsPath)/Editor/"
Copy-Item -Recurse "$IntegrationScriptsPath/Editor/CliConfiguration.cs" -Destination "$(GetNewProjectAssetsPath)/Editor/"